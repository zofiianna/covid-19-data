...
from bokeh.models import CategoricalColorMapper, HoverTool, ColumnDataSource, Panel, CDSView, GroupFilter
...
# Create a row layout
layout = row(column(controls_col, controls_row), p)

# Make a tab with the layout 
tab = Panel(child=layout, title = 'COVID-19 by State')
tabs = Tabs(tabs=[tab])
